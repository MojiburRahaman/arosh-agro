        ...
        <div class="">
            <article
                ...
                <section class="post_content">
                    ...
                    <div class="page_content_wrap page_paddings_yes md1">
                        <div class="content_wrap">
                                                    ...
                                                    <tbody class="load">
                                                        ...
                                                        <tr style="border-bottom: 1px solid rgb(211, 211, 211)">
                                                            ...
                                                            <td class="quantity  cart-plus-minus">
                                                                <input type="text" class="cart_quantity"
                                                                    name="cart_quantity"
                                                                    value="{{ $item->quantity }}" />
                                                            </td>
                                 ...
                                 if (result.dismiss === Swal.DismissReason.timer) {
                                     window.location.href = '{{route('CartDelete',$item->id)}}'
                                                                ...
                                                                <td class="remove text-center">
                                                                    ...
                                                                    &nbsp;
                                                                    <a href="{{route('CartDelete',$item->id)}}"
                                                                        class="mt-2 " data-abc="true">
                         ...
                         if (result.dismiss === Swal.DismissReason.timer) {
                             window.location.href = '{{route('CartDelete',$item->id)}}'
                                                                ...
                                                                @endif
                                                                @empty
                                                                <td style="border-bottom: 1px solid rgb(211, 211, 211)"
                                                                    colspan="10" class="text-center">
                                                ...
                                                <div class="card mb-3">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group"> <label>Have coupon?</label>
                                                            ...
                                                            <span style="font-size: 13.5px" id="invalid_coupon"
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <dl class="dlist-align" id="discount_coupon">
                                                            ...
                                                            <dd class="text-right text-danger ml-3"><span
                                                                    class="discount"> ৳
                                                        ...
                                                        <dl class="dlist-align">
                                                            <dt>Sub Total:</dt>
                                                            <dd class="text-right text-dark b ml-3"><strong> <span
                                                                        id="subtotal" class="cart_total">
                                                        ...
                                                        <a href="{{route('CheckoutView')}}"
                                                            class="btn btn-out   btn-square btn-main btn-light"
