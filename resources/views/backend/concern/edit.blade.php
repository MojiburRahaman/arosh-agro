...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Sister Concern</h1>
                </div><!-- /.col -->
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="col-12">
                <form enctype="multipart/form-data" action="{{route('sister-concern.update',$concern->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <label for="cocern_name">Concern Name</label>
                        <input value="{{$concern->cocern_name}}" name="cocern_name" type="text" placeholder="concern Name"
                            autocomplete="none" class="form-control @error('cocern_name') is-invalid                                
                            @enderror">
                        @error('cocern_name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="about_concern"
                            ...
                            name="about_concern"
                            id="about_concern">{{$concern->about_concern}}</textarea>
                        @error('about_concern')
                        <div class="alert alert-danger">
                            {{$message}}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$concern->weblink}}" name="weblink" type="text" placeholder="link"
                            autocomplete="none" class="form-control @error('weblink') is-invalid                                
                            @enderror">
                        @error('weblink')
                        <div class="alert alert-danger">
                            {{$message}}
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="address"
                            ...
                            name="address"
                            id="address">{{$concern->address}}</textarea>
                        @error('address')
                        <div class="alert alert-danger">
                            {{$message}}
                        </div>
