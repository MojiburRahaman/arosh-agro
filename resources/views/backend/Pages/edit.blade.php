            ...
            <div class="col-12">
                <form enctype="multipart/form-data" action="{{route('pages.update',$pages->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$pages->title}}" name="title" type="text" placeholder="page title"
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$pages->heading}}" name="heading" type="text" placeholder="page heading"
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-4 pl-4">
                                ...
                                &nbsp;<img src="{{asset('thumbnail_img/' .$pages->thumbnail_img)}}" id="image_id"
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description"
                            ...
                            name="description"
                            id="description">{{$pages->description}}</textarea>
                        @error('description')
                        <div class="alert alert-danger">
                            {{$message}}
                        </div>
