...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Image or Video</h1>
                </div><!-- /.col -->
            ...
            <div class="col-12">
                <form enctype="multipart/form-data" action="{{route('gallery.update',$gallery->id)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$gallery->image_title}}" name="image_title" type="text" placeholder="Image Title"
                            autocomplete="none" class="form-control @error('image_title') is-invalid                                
                            @enderror">
                        @error('image_title')
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-8 mt-4 pt-4">
                                <label for="image"> (Width: 940 px and Height:629)</label>
                            ...
                            <div class="col-4 pl-4">
                                <div>
                                    <label for="image_id">*Image Preview</label>
                                </div>
                                &nbsp;<img src="{{asset('image/' .$gallery->image)}}" id="image_id"
                        ...
                        <input value="{{$gallery->video_title}}" name="video_title" type="text" placeholder="Image Title"
                            autocomplete="none" class="form-control @error('video_title') is-invalid                                
                            @enderror">
                        @error('video_title')
                        <div class="alert alert-danger">
                            {{$message}}
